...
DynamicFilterState::DynamicFilterState() : time(0), x(3), dx(3), mask(32, false), xi_m_2(32), pas_pos(3), C_rows(32), is_first(false), is_second(false), is_failed(false) {}
DynamicFilterState::DynamicFilterState(int time, 
                                       ...
                                       time(time), x(x), dx(dx), 
                                       mask(mask), xi_m_2(xi_m_2), pas_pos(pas_pos), 
                                       C_rows(C_rows),
